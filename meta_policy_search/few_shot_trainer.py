...
class Trainer(object):
    ...
    def train(self, task, model_path):
        ...
        with self.sess.as_default() as sess:
            ...
            if model_path != False:
                ...
                print(self.algo.inner_lr)
            else:
                pass

            # self.sampler.update_tasks()
            self.policy.switch_to_pre_update()  # Switch to pre-update policy
            self.sampler_for_learning.vec_env.set_tasks(task) # task setting
            self.sampler_for_test.vec_env.set_tasks(task) # task setting
