...
class Procurement:
    ...
    def order_material(self, supplier, inventory, daily_events, lead_time_dict):
        ...
        while True:
            ...
            #order_size = 2
            self.order_qty = I[ASSEMBLY_PROCESS][self.item_id]["LOT_SIZE_ORDER"] 
            ...
            if self.order_qty > 0:
                ...
                inventory.update_inven_level(
                    self.order_qty, "IN_TRANSIT", daily_events)
                ...
                self.env.process(supplier.deliver_to_manufacturer(
                    self, self.order_qty, inventory, daily_events, self.lead_time)) # lead_time_dict->self.lead_time
...
class Customer:
    ...
    def order_product(self, sales, product_inventory, daily_events, scenario):
        ...
        while True:
            ...
            I[ASSEMBLY_PROCESS][0]["DEMAND_QUANTITY"] = DEMAND_QTY_FUNC(self.demand_qty_dict)
