...
if __name__=="__main__":
    ...
    config = {
        ...
        # sampler config
        'rollouts_per_meta_task': 1, # number trajectorys for adapting inner loop
...
#    logger.configure(dir=f"{SAVED_MODEL_PATH}", format_strs=['stdout', 'log', 'csv'],
#                     snapshot_mode='last_gap')
    
#    json.dump(config, open(f"{SAVED_MODEL_PATH}" + '/params.json', 'w'), cls=ClassEncoder)
